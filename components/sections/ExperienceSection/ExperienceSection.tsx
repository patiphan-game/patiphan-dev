  ...
  return (
    ...
    >
      <div className="mx-5 lg:mx-0">
        ...
        <TextAnimate text="Experience" type="fadeIn" />
        ...
        <div className="flex w-full flex-col gap-6 rounded-xl p-6 shadow-xl dark:shadow-slate-900">
          ...
          <ul className="list-disc space-y-2 pl-5 dark:text-slate-300">
            <li className="text-sm">
              Learned fundamental web technologies including HTML, CSS, and
              modern JavaScript (ES6), enabling proficiency in frontend
              development.
            </li>
            <li className="text-sm">
              Acquired expertise in building dynamic user interfaces with React
              JSX, including advanced component architecture and state
