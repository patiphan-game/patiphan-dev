  ...
  return (
    ...
    >
      <div className="mx-5 mb-14 flex flex-col items-center gap-5 md:mb-24 lg:mx-0">
        <div className="text-2xl font-semibold md:text-3xl">Get In Touch</div>
        ...
        <div className="flex items-center space-x-2 font-semibold">
          ...
          <div
            ...
            className="relative cursor-pointer rounded-md p-1 transition duration-200 hover:bg-slate-100 dark:hover:bg-slate-800"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="21"
        ...
        <a href="mailto:Patiphan.arp@gmail.com" target="_blank">
          <p className="underline underline-offset-4 transition duration-200 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">
            Send me the email !
          </p>
        </a>
            ...
            <div className="flex gap-5">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 transition-transform duration-200 hover:rotate-12 hover:scale-125"
                >
                  <title>LinkedIn</title>
                  <path
                    fill="white"
